...
{
    system("cls");
    Organiser obj1("ENGIFEST", "2-10", "ENGIFEST TEAM", "DELHI TECHNOLOGICAL UNIVERSITY", "ETHNIC", "AIM SHOOTING", "FOOD STALL", "GUESS GAME", "DICE GAME(2 Player Game)", "LUCKY CHAIR");
    cout << "\n\n\t\t--------ENGIFEST WELCOMES YOU ALL! HAVE FUN :)---------\n\n";
    system("pause");
    int n;
